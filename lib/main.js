...
var SearchManager = {
    ...
    init: function()
    {
        ...
        {
            ss.storage.searchHistory = {numSearches: [0, 0], mostRecentSearches: []};
        }
    ...
    updateSearchList: function(ts, te, n, query)
    {
        ...
        {
            this.logPendingSearch(query, 0, keywordsList);
        }
...
var ProactiveSearchManager = {
    ...
    /* 
     * Schedule to perform 'numSearches' every 'period' time (in seconds).
    ...
    start: function(period, numProactiveSearches)
    {
        ...
        {
            this.searchStates.period = period * 1000;
...
var DSGUIManager = 
{
    ...
    updateSearchHistory: function(searchHistory, fullUpdate)
    {
        ...
        {
            var msg = {cmd: 'full', data: searchHistory, numScheduledSearches: SearchManager.searchVector.length};
...
exports.main = function(options, callbacks)
{
    ...
    require("sdk/timers").setTimeout(function callback(e){  
        ...
        ProactiveSearchManager.start(2* 3600, 10);
